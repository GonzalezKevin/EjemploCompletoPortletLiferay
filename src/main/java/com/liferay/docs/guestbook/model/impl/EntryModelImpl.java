...
/**
 * The base model implementation for the Entry service. Represents a row in the &quot;pruebas_Entry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class EntryModelImpl extends BaseModelImpl<Entry> implements EntryModel {
     ...
     */
    public static final String TABLE_NAME = "pruebas_Entry";
    ...
    public static final String TABLE_SQL_CREATE = "create table pruebas_Entry (uuid_ VARCHAR(75) null,entryId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,email VARCHAR(75) null,message VARCHAR(75) null,guestbookId LONG)";
    public static final String TABLE_SQL_DROP = "drop table pruebas_Entry";
    public static final String ORDER_BY_JPQL = " ORDER BY entry.entryId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY pruebas_Entry.entryId ASC";
