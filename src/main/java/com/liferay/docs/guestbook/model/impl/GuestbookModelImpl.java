...
/**
 * The base model implementation for the Guestbook service. Represents a row in the &quot;pruebas_Guestbook&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class GuestbookModelImpl extends BaseModelImpl<Guestbook>
     ...
     */
    public static final String TABLE_NAME = "pruebas_Guestbook";
    ...
    public static final String TABLE_SQL_CREATE = "create table pruebas_Guestbook (uuid_ VARCHAR(75) null,guestbookId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table pruebas_Guestbook";
    public static final String ORDER_BY_JPQL = " ORDER BY guestbook.guestbookId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY pruebas_Guestbook.guestbookId ASC";
